    ...
    <section id="about" className="bg-neutral-200 py-20 pb-0 min-h-screen">
      <div className="container mx-auto flex items-center justify-center">
        <div className="max-w-4xl mx-auto flex items-center">
          ...
          <div className="w-1/2 px-8 py-6 flex items-center justify-center">
            <div>
              <h3 className="text-3xl font-bold text-blue-600 mb-4">About Me</h3>
              <h4 className="text-2xl text-black mb-6">
